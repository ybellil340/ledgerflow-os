...
const statusColors: Record<string, string> = {
  draft: "bg-muted text-muted-foreground", pending: "bg-warning/10 text-warning",
  approved: "bg-success/10 text-success", paid: "bg-primary/10 text-primary",
  ...
  return (
    <div className="p-6 lg:p-8 max-w-[1400px]">
      <div className="flex items-center justify-between mb-6">
        <div><h1 className="text-xl font-semibold">AR Invoices</h1><p className="text-muted-foreground text-sm">Accounts receivable invoices</p></div>
              ...
              <tbody>
                {invoices.map((inv: any) => (
                  <tr key={inv.id} className="border-b last:border-0">
                    ...
                    <td className="px-4 py-3 text-sm text-muted-foreground">{inv.customers?.name || "—"}</td>
